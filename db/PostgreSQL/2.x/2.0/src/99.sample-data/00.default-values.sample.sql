...
INSERT INTO finance.accounts(account_master_id,account_number,account_name, sys_type, parent_account_id) 
SELECT 20100,  '30200', 'Interest Income',                                            FALSE, finance.get_account_id_by_account_name('Revenues');
INSERT INTO finance.accounts(account_master_id,account_number,account_name, sys_type, parent_account_id) 
...
SELECT 'ABN AMRO Savings A/C', finance.get_account_id_by_account_number('10102'), 1, false, core.get_office_id_by_office_name('Default'), 'ABN AMRO Bank', '';
